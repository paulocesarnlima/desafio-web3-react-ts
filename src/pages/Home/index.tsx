...
export const Home = () => { 
    ...
    const idioma = [{
        en: "Hello, my name is Paulo Lima and I am a Front-End Developer, Technologies that I have experience:",
        pt: "Olá, meu nome é Paulo Lima e eu sou Desenvolvedor Front-End, Tecnologias que tenho experiência:",
        es:"Hola, mi nombre es Paulo Lima y soy Desarrollador Front-End, Tecnologías en las que tengo experiencia:"
    }]
